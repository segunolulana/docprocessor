...
def load_gensim_embedding_model(model_name):
    ...
    # TODO Ability to load custom mode like this commented out code
    # model_path = gensim_data_downloader.load(model_name, return_path=True)
    # output = KeyedVectors.load_word2vec_format(model_path, binary=True, unicode_errors='ignore')
    output = gensim_data_downloader.load(model_name)
    return output
